...
<body>
     ...
     <div class="error">
      ...
      <form action="member_logsp.php" method='POST' autocomplete="off">
          <div class="label3">
...
if(!empty($uni_id) && !empty($password)){
  $sql1 = "SELECT * FROM member_reg WHERE uni_id = '$uni_id' AND password = '$password' AND club_name='sports club' AND status ='1'";
  $sql2 = "SELECT * FROM member_reg WHERE uni_id = '$uni_id' AND password = '$password' AND club_name='sports club' AND status ='0'";
  ...
  $query2 = $conn->query($sql2);
   ...
   if($query1->num_rows > 0){
    ...
    header('location:sportsclub.php');
  }
