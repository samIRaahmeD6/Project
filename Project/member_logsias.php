...
if(!empty($uni_id) && !empty($password)){
  ...
  $sql1 = "SELECT * FROM member_reg WHERE uni_id = '$uni_id' AND password = '$password' AND club_name='sias' AND status ='1'";
  $sql1 = "SELECT * FROM member_reg WHERE uni_id = '$uni_id' AND password = '$password' AND club_name='sias' AND status ='0'";
